...
enum class Age(
    ...
    companion object {
        fun distributedRandom() = values().toList().distributedRandom()
...
interface Language : NamedResource {
    ...
    companion object {
        fun values(): List<Language> = CommonLanguage.values().toList() + ExoticLanguage.values().toList()
        fun random() =
            (CommonLanguage.values().toList() + ExoticLanguage.values()).random() as Language
    }
}
...
enum class CommonLanguage(
    ...
    companion object {
        fun random(excluding: List<Language>) = values().filter { it !in excluding }.random()
    }
}
...
enum class Race(
    ...
    HillDwarf(R.string.race_hill_dwarf, 8.75,
        CommonLanguage.Dwarvish
    ),
    MountainDwarf(R.string.race_mountain_dwarf, 8.75,
        CommonLanguage.Dwarvish
    ),
    ...
    ForestHalfling(R.string.race_forest_halfling, 8.75,
        CommonLanguage.Halfling
    ),
    RockHalfling(R.string.race_rock_halfling, 8.75,
        CommonLanguage.Halfling
    ),

    Human(R.string.race_human, 17.5, null),

    Dragonborn(R.string.race_dragonborn, 6.0,
        ExoticLanguage.Draconic
    ),

    ForestGnome(R.string.race_forest_gnome, 3.0,
        CommonLanguage.Gnomish
    ),
    RockGnome(R.string.race_rock_gnome, 3.0,
        CommonLanguage.Gnomish
    ),
    ...
    Tiefling(R.string.race_tiefling, 6.0,
        ExoticLanguage.Infernal
    );
...
fun <T: RandomDistributed> List<T>.distributedRandom(): T {
