...
enum class Race(
    ...
    StoutHalfling(R.string.race_stout_halfling, 8.75, CommonLanguage.Halfling),
    LightfootHalfling(R.string.race_lightfoot_halfling, 8.75, CommonLanguage.Halfling),
